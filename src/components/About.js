    ...
    <>
      <ScrollRestoration/>
        <Flex as="article" id="about" alignItems="center" flexDir="column" bg="#FCFAF5">
          <Flex justify="center" bg="primary.50" w="100vw">
            <Flex alignItems="center" flexDirection="column" padding={{base: "10", sm: "20"}} paddingY={{base: "10", sm: "20"}} maxWidth={1500} h="fit-content" borderRadius={10}>
                <Flex flexDirection="column" alignItems="left">
                  ...
                  <Tabs variant="solid-rounded" colorScheme="orange" defaultIndex={6}>
                    <TabList display="flex" flexWrap="wrap" marginY={5} border="transparent">
                      ...
                      <TabPanels bg="primary.100" borderRadius={10} padding={10}>
                        <TabPanel>
                          <Text>
